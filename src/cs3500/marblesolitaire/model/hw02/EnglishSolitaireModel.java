...
/**
 * This class is an implementation of the MarbleSolitaireModel interface that makes the
 * model of the game.
 */
public class EnglishSolitaireModel implements MarbleSolitaireModel {
   ...
   *
   * @param armThickness the arm thickness on the board
   */
  ...
  public EnglishSolitaireModel(int armThickness, int sRow, int sCol) {
    ...
    int upper = 2 * armThickness - 2;
    if ((sRow < lower && sCol < lower) || (sRow > upper && sCol > upper)
            || (sRow < lower && sCol > upper) || (sRow > upper && sCol < lower)) {
  ...
  public boolean isInvalid(int row, int col) {
    ...
    if ((row < lower && col < lower) || (row > upper && col > upper)
            || (row < lower && col > upper) || (row > upper && col < lower)) {
      invalid = true;
    }
    return invalid;
  }
